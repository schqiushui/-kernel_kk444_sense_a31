...
#define HTC_8916_USB1_HS_ID_GPIO_A31 50 + 902
...
static int htc_get_usbid(void)
{
	...
	else if (of_board_is_a31dtgl() || of_board_is_a31dtul()
			|| of_board_is_a31dugl() || of_board_is_a31ul())
		usbid_gpio = HTC_8916_USB1_HS_ID_GPIO_A31;
	else
...
#if defined(CONFIG_MACH_A31_DTUL) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_DUMMY)\
				   || defined(CONFIG_MACH_A31_UL)
	rom_check_pass = 1;
#endif
